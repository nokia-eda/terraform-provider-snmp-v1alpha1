...
package resource_cluster_destination
...
func ClusterDestinationResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterDestination$"), ""),
				},
				Default: stringdefault.StaticString("ClusterDestination"),
			},
