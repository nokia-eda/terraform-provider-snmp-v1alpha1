...
package datasource_cluster_trap_group_list
...
func ClusterTrapGroupListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterTrapGroupListModel struct {
