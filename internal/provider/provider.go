...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snmp/internal/eda/utils"
...
var _ provider.Provider = (*snmpProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &snmpProvider{version: ver}
	}
}
...
func (p *snmpProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *snmpProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *snmpProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "snmp-v1alpha1"
	resp.Version = p.version
}

func (p *snmpProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterDestinationDataSource,
		NewClusterDestinationListDataSource,
		NewClusterTrapGroupDataSource,
		NewClusterTrapGroupListDataSource,
		NewDestinationDataSource,
		NewDestinationListDataSource,
		NewResourceListDataSource,
		NewTrapGroupDataSource,
		NewTrapGroupListDataSource,
	}
}

func (p *snmpProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterDestinationResource,
		NewClusterTrapGroupResource,
		NewDestinationResource,
		NewTrapGroupResource,
	}
}
