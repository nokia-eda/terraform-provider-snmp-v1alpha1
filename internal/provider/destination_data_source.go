...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snmp/internal/datasource_destination"
...
const read_ds_destination = "/apps/snmp.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
...
func (d *destinationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_destination, map[string]string{
