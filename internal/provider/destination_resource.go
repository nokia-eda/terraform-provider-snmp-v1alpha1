...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snmp/internal/resource_destination"
	"github.com/nokia/eda/apps/terraform-provider-snmp/internal/tfutils"
)

const (
	create_rs_destination = "/apps/snmp.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations"
	read_rs_destination   = "/apps/snmp.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
	update_rs_destination = "/apps/snmp.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
	delete_rs_destination = "/apps/snmp.eda.nokia.com/v1alpha1/namespaces/{namespace}/destinations/{name}"
)
...
func (r *destinationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_destination, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_destination, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_destination,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *destinationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_destination, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *destinationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_destination, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
