...
package resource_cluster_trap_group
...
func ClusterTrapGroupResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^snmp\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("snmp.eda.nokia.com/v1alpha1"),
			},
			"kind": schema.StringAttribute{
				Optional: true,
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterTrapGroup$"), ""),
				},
				Default: stringdefault.StaticString("ClusterTrapGroup"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ClusterTrapGroup",
				MarkdownDescription: "name of the ClusterTrapGroup",
			},
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"destinations": schema.ListAttribute{
						ElementType:         types.StringType,
						Required:            true,
						Description:         "List of SNMP Destinations",
						MarkdownDescription: "List of SNMP Destinations",
					},
					"names": schema.ListAttribute{
						ElementType:         types.StringType,
						Optional:            true,
						Description:         "List of SNMP trap names to be sent out.",
						MarkdownDescription: "List of SNMP trap names to be sent out.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				Required:            true,
				Description:         "ClusterTrapGroupSpec defines the desired state of ClusterTrapGroup",
				MarkdownDescription: "ClusterTrapGroupSpec defines the desired state of ClusterTrapGroup",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "ClusterTrapGroupStatus defines the observed state of ClusterTrapGroup",
				MarkdownDescription: "ClusterTrapGroupStatus defines the observed state of ClusterTrapGroup",
			},
		},
	}
}

type ClusterTrapGroupModel struct {
