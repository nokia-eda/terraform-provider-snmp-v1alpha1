	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^Destination$"), ""),
				},
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DestinationSpec defines the desired state of Destination",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DestinationStatus defines the observed state of Destination",
			},
		},
	}
}
