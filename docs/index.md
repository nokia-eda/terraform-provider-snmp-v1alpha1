---
page_title: "snmp-v1alpha1 Provider"
---

# snmp-v1alpha1 Provider

This provider is used to interact with the resources provided by the **snmp-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
